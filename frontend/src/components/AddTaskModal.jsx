      ...
      <div className="bg-white w-full max-w-md rounded-[40px] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest underline decoration-orange-200 underline-offset-4">
              Task Mission
            </label>
            <input
              autoFocus
              className="w-full text-lg font-bold border-b-2 border-gray-100 focus:border-[#FF6B00] outline-none py-2 transition-colors placeholder:text-gray-200"
            ...
            <div className="flex items-center justify-center gap-3 select-none">
              ...
              <div className="flex flex-col items-center gap-2">
                <input
                  ...
                  className="w-20 h-20 bg-gray-50 border-2 border-transparent focus:border-[#FF6B00] focus:bg-white rounded-2xl text-center text-3xl font-black text-gray-800 outline-none transition-all"
                  placeholder="12"
                />
              ...
              <span className="text-4xl font-black text-gray-300 mb-6">:</span>
              ...
              {/* AM/PM Switch */}
              <div className="flex flex-col border-2 border-gray-100 rounded-2xl overflow-hidden ml-2 mb-6">
                {["AM", "PM"].map((p) => (
                  <button
                    key={p}
                    type="button"
          ...
          <div className="space-y-2">
            ...
            <textarea
              className="w-full text-sm text-gray-600 bg-gray-50 rounded-2xl p-4 outline-none focus:ring-2 focus:ring-orange-100 resize-none h-20 border border-gray-100"
