...
const DailyChallenge = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 p-8 rounded-3xl shadow-sm hover:shadow-md transition-all h-full flex flex-col justify-between">
      <div>
        <div className="flex justify-between items-start mb-6">
          ...
          <span className="text-[10px] font-black text-gray-400 dark:text-gray-300 uppercase tracking-widest bg-gray-50 dark:bg-gray-700 px-3 py-1 rounded-full">
            Daily Objective
          </span>
        </div>
      ...
      <div className="space-y-6">
        ...
        {/* Status Section */}
        {isCompleted ? (
          <div className="w-full py-4 bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 rounded-2xl font-bold flex items-center justify-center gap-3 border border-green-100 dark:border-green-800/30">
            <CheckCircle2 size={20} />
            Goal Achieved
          </div>
        ) : (
          <div className="w-full py-3 bg-gray-50 dark:bg-gray-700/50 text-gray-500 dark:text-gray-400 rounded-2xl text-sm font-medium flex items-center justify-center gap-2 border border-gray-100 dark:border-gray-700">
